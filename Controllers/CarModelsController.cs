...
namespace AzureWebApp.Controllers
{
    public class CarModelsController : Controller
    {
        ...
        public CarModelsController(AzureWebAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,Model,Horsepower,Price")] CarModel carModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,Model,Horsepower,Price")] CarModel carModel)
        {
            if (id != carModel.Id)
            {
                return NotFound();
